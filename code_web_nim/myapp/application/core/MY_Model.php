...
class MY_Model extends CI_Model {
	 ...
	 * $field='pass_root,ip_node'
	 * ví dụ $field='ip_node,hostname_node'
	 *
	 * ví dụ so sánh nhiều khoảng
	...
	protected function get_list_set_input($input = array())
	{
		...
		/////'name' trường cần tìm kiếm
		///$name là kí tự cần truyền vào để tìm kiếm
		...
		//(ví dụ $input['limit'] = array('10' ,'0'))  lấy 10 bản tin bắt đầu từ vị trí 0
