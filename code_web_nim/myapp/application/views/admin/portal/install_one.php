            ...
            <?php $this->load->view('admin/message', $this->data);?>
              <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title">Cấu hình cho VM Portal</h4>
                </div>
                <div class="card-body ">
                  <!-- <form class="form-horizontal"> -->
                    <div class="row">
                      <label class="col-md-3 col-form-label">Khai báo các thông số cho việc cấu hình portal:</label>
                      <div class="col-md-9">
                        <div class="form-group has-default">
                          <button id="config_portal" class="btn btn-primary">Thực hiện</button>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-check">
                          <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="option_ssl" value="default" checked>Sử dụng mặc định
                            <span class="circle">
                        ...
                        <div class="form-check">
                          <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="option_ssl" value="update">Thêm mới
                            <span class="circle">
                              <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-4">
                        <div class="form-group has-default">
                          <button id="add_ssl" class="btn btn-primary">Thêm SSL</button>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-9">
                        <div class="form-group has-default">
                          <button id="install_portal_one" class="btn btn-primary">Thực hiện</button>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-9">
                        <div class="form-group has-default">
                          <button id="log_install_portal_one" class="btn btn-primary">Thực hiện</button>
                        </div>
                      </div>
                    </div>
                </div>
