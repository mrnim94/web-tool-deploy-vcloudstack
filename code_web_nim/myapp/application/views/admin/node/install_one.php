...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-6">
            <iframe  src="https://192.168.1.8:8006/?console=kvm&novnc=1&vmid=100&vmname=portal-vCloudStack&node=vcloudstack01" frameborder="0" scrolling="no" width="1024px" height="100%"></iframe>
          </div>
        </div>
        <!-- end row -->
    </div>
