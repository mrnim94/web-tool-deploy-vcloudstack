            ...
            <?php $this->load->view('admin/message', $this->data);?>
              <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title">Cấu hình cho node vật lý Slave</h4>
                </div>
                <div class="card-body ">
                  <!-- <form class="form-horizontal"> -->
                    ...
                    <div class="row">
                      <label class="col-md-3 col-form-label">Phân vùng ổ đĩa và update storage:</label>
                      <div class="col-md-9">
                        <div class="form-group has-default">
                          <button id="chia_o_dia_and_update_storage" class="btn btn-primary">Phân vùng và update</button>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <label class="col-md-3 col-form-label">Thêm node slave vào cluster:</label>
                      <div class="col-md-3">
                        <div class="form-group has-default">
                          <button id="add_node_to_cluster" class="btn btn-primary">Thực hiện</button>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group has-default">
