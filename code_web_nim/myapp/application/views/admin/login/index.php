...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jun 2018 16:14:50 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo public_url('admin/') ?>assets/img/apple-icon.png">
    <link rel="icon" type="image/png" href="<?php echo public_url('admin/') ?>assets/img/favicon.png">
    ...
    <meta itemprop="image" content="<?php echo public_url('admin/') ?>s3.amazonaws.com/creativetim_bucket/products/51/original/opt_mdp_thumbnail.jpg">
    ...
    <meta name="twitter:image" content="<?php echo public_url('admin/') ?>s3.amazonaws.com/creativetim_bucket/products/51/original/opt_mdp_thumbnail.jpg">
    ...
    <meta property="og:image" content="<?php echo public_url('admin/') ?>s3.amazonaws.com/creativetim_bucket/products/51/original/opt_mdp_thumbnail.jpg" />
    <meta property="og:description" content="Material Dashboard PRO is a Premium Material Bootstrap 4 Admin with a fresh, new design inspired by Google's Material Design." />
    <meta property="og:site_name" content="Creative Tim" />

    <!--     Fonts and icons     -->
    <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Roboto+Slab:400,700|Material+Icons" />
    <link rel="stylesheet" href="<?php echo public_url('admin/') ?>maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css">

    <!-- CSS Files -->

    <link href="<?php echo public_url('admin/') ?>assets/css/material-dashboard.min40a0.css?v=2.0.2" rel="stylesheet" />

    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link href="<?php echo public_url('admin/') ?>assets/demo/demo.css" rel="stylesheet" />
...
<body class="off-canvas-sidebar login-page">
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-transparent navbar-absolute" color-on-scroll="500">
        <div class="container">
            <div class="navbar-wrapper">
                <a class="navbar-brand" href="#pablo"><strong>MP Telecom</strong></a>
            </div>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item  active ">
                        <a href="<?php echo admin_url('login');?>" class="nav-link">
    ...
    <div class="wrapper wrapper-full-page">
        <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('<?php echo public_url('admin/') ?>assets/img/login.jpg'); background-size: cover; background-position: top center;">
            <!--   you can change the color of the filter page using: data-color="blue | purple | green | orange | red | rose " -->

            <div class="container">
                <div class="col-md-4 col-sm-6 ml-auto mr-auto">
                    <form class="form" method="POST" action="<?php admin_url('login') ?>">
                        ...
                        <div class="card card-login card-hidden">
                            ...
                            <div class="card-body ">
                                ...
                                <p class="card-description text-center">Mời đăng nhập</p>
                                <strong style=" color: red; text-align: center;"><?php echo form_error('login');?></strong>
    ...
    <div class="card-footer justify-content-center">
        <button type="submit" class="btn btn-success">Lets Go<div class="ripple-container"></div></button>
    </div>
    ...
    <footer class="footer ">
        ...
        <div class="container">
            ...
            <div class="copyright pull-right">
                ...
                </script>, made with <i class="material-icons">favorite</i> by <a href="https://www.creative-tim.com/" target="_blank">Mr Nim</a> for a better web.
            </div>
        </div>
...
<!--   Core JS Files   -->
    ...
    <script src="<?php echo public_url('admin/') ?>assets/js/material-dashboard.min40a0.js?v=2.0.2" type="text/javascript"></script>
